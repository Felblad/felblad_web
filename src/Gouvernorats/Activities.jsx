...
const gouvernorats = [
  ...
  const categories = [
    [
        ...
        {
            "name": "Salle de fête",
            "image_url": "/categories/Salle de fête.jpeg"
        },
        {
        ...
        <div className="container-cat">
            ...
            <div className="middle-section">
                ...
                <div className="background-image-container">
                    <img
                        src={gouvernorats[0]["Ariana"].image_url} // Replace with actual image URL
                        alt="Gouvernaurat"
                        className="gouvernaurat-image"
                    />
                    <div className="image-overlay-text">
                        <p className="gouvernaurat-name">{Object.keys(gouvernorats[0])}</p>
                    </div>
                </div>
                ...
                <div className="categories-list-container">
                    <div className="categories-grid">
                        {categories.map((categoryGroup, index) => (
                            <div key={index} className="category-item-cat"
                            onClick={() => {navigate('/SousCategories');}}>
                                <div className="image-container-cat">
                                    <img
                                        src={categoryGroup[0].image_url}
                                        alt={categoryGroup[0].name}
                                        className="image-cat"
                                    />
                                    <div className="overlay-cat">
                                        <div className="overlay1-cat">
                                            <p className="category-name-cat">{categoryGroup[0].name}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
